...
const UsAgreement = () => {
  return (
    <AffiliatesProgramLayout>
      <Container>
        <Text as="h1">Mokoi Affiliate Program Agreement</Text>
        <Text as="h3">Last modified: DEC 5, 2024</Text>
        <Text as="p">
          This Mokoi Affiliate Program Agreement (“<strong>Agreement”</strong>) is a legal contract between you (“
          <strong>Affiliate”</strong>) and Mokoi that applies to your participation in the Mokoi Affiliate
          Program (“Program”). In this Agreement, “<strong>Mokoi</strong>,” “<strong>we</strong>” or “
          <strong>us</strong>” means Mokoi. If you are participating or registering on behalf of a business, then
          ...
          web page), you agree to this Agreement which may be amended from time to time by Mokoi.
        </Text>
        ...
        <Text as="p">
          ...
          users (“<strong>Referrals”</strong>) to register and trade on Mokoi, in accordance with the terms of
          this Agreement.
        </Text>
        <Text as="p">
          1.2 A Referral must be a new user and must not have interacted or signed with the Mokoi platform or used
          any of Mokoi’s services (including but not limited to V2, V3 swapping services, perpetual trading,
          Non-Fungible Tokens and related services, initial farm offerings and similar offerings) (“Mokoi
          Services”).
        </Text>
        ...
        <Text as="p">
          (a) <strong>3</strong>% on trading fees paid by your Referrals on Mokoi V2 and Mokoi V3, limited
        ...
        <Text as="p">
          7.3 Any statements you make about Mokoi must reflect your honest opinions, beliefs, or experiences and
        ...
        <Text as="p">You warrant, represent, and undertake to Mokoi that:</Text>
        ...
        <Text as="p">
          ...
          not that of employer and employee. You will not be treated as an employee of Mokoi for any purpose.
          ...
          offers or representations on behalf of Mokoi. You shall have no authority to bind Mokoi, and
          undertake not to hold yourself out as an employee, agent or authorised representative of Mokoi.
        </Text>

        <Text as="h3">12. No Joint Publicity</Text>
        <Text as="p">
          You may not claim that any materials are created jointly between you and Mokoi, or attribute any
          materials created or issued by you (including press releases) to Mokoi.
        </Text>

        <Text as="h3">13. Term and Termination</Text>
        <Text as="p">
          13.1 Mokoi reserves the right to terminate this Agreement in its entirety with or without cause,
          ...
          reason, you shall immediately cease use of (and remove from your site) all links to the Mokoi website
          and all images of Mokoi and other materials provided under the Program.
        </Text>
        <Text as="p">
          13.2 Mokoi, in its sole discretion, reserves the right to suspend or terminate your account and refuse
          any and all current or future use of the Program, or any other Mokoi service, for any reason and at any
          time. Such termination will result in the deactivation or deletion of your Affiliate Account.
        </Text>
        <Text as="p">13.3 Mokoi reserves the right to refuse service to anyone for any reason at any time.</Text>

        <Text as="h3">14. Indemnification</Text>
        <Text as="p">
          You shall indemnify Mokoi from and against all claims, losses, liabilities, damages, administrative
        ...
        <Text as="p">
          Mokoi and any of Mokoi&apos;s officers, directors, employees, shareholders or agents of any of
        ...
        <Text as="p">
          (e) directing or causing existing users or previous users of Mokoi Services to create new addresses to
          sign up with your referral link
        </Text>
        <Text as="p">
          (f) Conduct marketing or make any representations of any Mokoi products and services to users in the
        ...
        <Text as="p">
          Mokoi may provide you with trademarks and/or graphical images that can be used to promote Mokoi.
          You may not modify these trademarks and/or images in any way. Mokoi reserves the right to change the
        ...
        <Text as="p">
          ...
          relationship as an Affiliate which is promoting Mokoi. For example:
        </Text>
        <Text as="p">
          (a) If you promote Mokoi through a web page, podcast, blog post, or social media post as an endorsement
          or review of Mokoi or incentivise others to do so, you must ensure that such post includes a clear
          disclosure that it is an advertisement or was otherwise promoted by Mokoi; and
        </Text>
        <Text as="p">
        ...
        <Text as="p">
          ...
          Zambia, Zimbabwe (or any additional country or jurisdiction added to this list by Mokoi from time to
