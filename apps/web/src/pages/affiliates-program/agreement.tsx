  ...
  return (
    <AffiliatesProgramLayout>
      <Container>
        ...
        <Text as="p">
          8.3 Any statements you make about Mokoi must reflect your honest opinions, beliefs, or experiences and
        ...
        <Text as="p">
          14.1 Mokoi reserves the right to terminate this Agreement in its entirety with or without cause,
        ...
        <Text as="p">
          14.2 Mokoi, in its sole discretion, reserves the right to suspend or terminate your account and refuse
        ...
        <Text as="p">14.3 Mokoi reserves the right to refuse service to anyone for any reason at any time.</Text>
