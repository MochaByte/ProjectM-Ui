...
export const inkTestnet: IceChain = {
  ...
  swap: {
    factoryAddress: '0x56e54E72E22e648A62e1e2a738f24881Db343Ec2', // Your factory contract address
    initCodeHash: '0x6ce8eb472fa82df5469c6ab6d485f17c3ad13c8cd7af59b3d4a8026c5ce0f7e2', // INIT_CODE_HASH from the factory contract
    routerAddress: '0x9863560B4C43c545765e1B84ad05dd8A16065c64', // Replace with the actual router address for Ink TestnetTODO
  },
  smartRouterAddress: '0x65e871159aEb64375af9188C461479E4D781487e', // Replace with Ink's smart router address if availableTODO
}
